 ...
 */
public class BoomSentryTurret extends Turret {
    public static final String RESOURCE = "nl/cas_en_luke/oopd_eindopdracht/images/turrets/sentry_boom_64.png";
    public static final double RANGE = 120.0;
    public static final double ANGULAR_SPEED = Math.PI * 4.0;
    ...
    public static final CoolDownTimer.Builder COOL_DOWN_TIMER_BUILDER = CoolDownTimer.newBuilder()
            .setImmediate(true)
            .setCoolDownTime(0.4);
    public static final Projectile.Builder<BombProjectile.Builder> PROJECTILE_BUILDER =
